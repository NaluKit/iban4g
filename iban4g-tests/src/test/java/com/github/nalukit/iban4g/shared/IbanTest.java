...
public class IbanTest {
  ...
  public static class IbanGenerationExceptionalTest {
    ...
    public void ibanConstructionWithoutAccountNumberShouldThrowException() {
      new Iban.Builder().countryCode(CountryCode.AT).bankCode("0001").branchCode("2030").build();
    }
    ...
    public void ibanBuilderConstructionSeeded() {
      assertIbanBuilderRandomWithSeedEquals("ME50 8734 4468 8937 3242 26", 1);
      assertIbanBuilderRandomWithSeedEquals("GE07 GA79 0697 8464 4467 90", 2);
      assertIbanBuilderRandomWithSeedEquals("IE87 MMHQ 2949 1527 4166 76", 3);
    }
