...
import de.gishmo.gwt.iban4g.shared.IbanFormatException.IbanFormatViolation;
...
public class IbanUtilTest {
  ...
  public static class IbanFormatExceptionActualValueMatcher
    ...
    public IbanFormatExceptionActualValueMatcher(String expectedValue) {
  ...
  public static class IbanFormatExceptionExpectedValueMatcher
    ...
    public IbanFormatExceptionExpectedValueMatcher(String expectedValue) {
      this.expectedValue = expectedValue;
    }
