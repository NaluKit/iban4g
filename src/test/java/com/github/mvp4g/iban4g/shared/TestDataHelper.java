...
final class TestDataHelper {
    ...
    return new HashMap<String, Iban>() {
      {
        put("AL47212110090000000235698741",
            new Iban.Builder().countryCode(CountryCode.AL)
                              .bankCode("212")
                              .branchCode("1100")
        ...
        put("AD1200012030200359100100",
            new Iban.Builder().countryCode(CountryCode.AD)
                              .bankCode("0001")
                              .branchCode("2030")
        ...
        put("BG80BNBG96611020345678",
            new Iban.Builder().countryCode(CountryCode.BG)
                              .bankCode("BNBG")
                              .branchCode("9661")
        ...
        put("FI2112345600000785",
            new Iban.Builder().countryCode(CountryCode.FI)
                              .bankCode("123456")
                              .accountNumber("0000078")
                              .nationalCheckDigit("5")
                              .build());
        put("FR1420041010050500013M02606",
            new Iban.Builder().countryCode(CountryCode.FR)
                              .bankCode("20041")
                              .branchCode("01005")
        ...
        put("IE29AIBK93115212345678",
            new Iban.Builder().countryCode(CountryCode.IE)
                              .bankCode("AIBK")
                              .branchCode("931152")
                              .accountNumber("12345678")
                              .build());
        put("IL620108000000099999999",
            new Iban.Builder().countryCode(CountryCode.IL)
                              .bankCode("010")
                              .branchCode("800")
                              .accountNumber("0000099999999")
                              .build());
        put("IT60X0542811101000000123456",
            new Iban.Builder().countryCode(CountryCode.IT)
                              .bankCode("05428")
                              .branchCode("11101")
        ...
        put("MU17BOMM0101101030300200000MUR",
            new Iban.Builder().countryCode(CountryCode.MU)
                              .bankCode("BOMM01")
                              .branchCode("01")
                              .accountNumber("101030300200000MUR")
                              .build());
        put("MD24AG000225100013104168",
            new Iban.Builder().countryCode(CountryCode.MD)
                              .bankCode("AG")
                              .accountNumber("000225100013104168")
                              .build());
        put("MC5811222000010123456789030",
            new Iban.Builder().countryCode(CountryCode.MC)
                              .bankCode("11222")
                              .branchCode("00001")
        ...
        put("PT50000201231234567890154",
            new Iban.Builder().countryCode(CountryCode.PT)
                              .bankCode("0002")
                              .branchCode("0123")
        ...
        put("RO49AAAA1B31007593840000",
            new Iban.Builder().countryCode(CountryCode.RO)
                              .bankCode("AAAA")
                              .accountNumber("1B31007593840000")
                              .build());
        put("QA58DOHB00001234567890ABCDEFG",
            new Iban.Builder().countryCode(CountryCode.QA)
                              .bankCode("DOHB")
        ...
        put("SA0380000000608010167519",
            new Iban.Builder().countryCode(CountryCode.SA)
                              .bankCode("80")
                              .accountNumber("000000608010167519")
                              .build());
        put("RS35260005601001611379",
            new Iban.Builder().countryCode(CountryCode.RS)
                              .bankCode("260")
                              .branchCode("26")
        ...
        put("SK3112000000198742637541",
            new Iban.Builder().countryCode(CountryCode.SK)
                              .bankCode("1200")
                              .accountNumber("0000198742637541")
                              .build());
        put("SI56263300012039086",
            new Iban.Builder().countryCode(CountryCode.SI)
                              .bankCode("26")
                              .branchCode("330")
        ...
        put("ES9121000418450200051332",
            new Iban.Builder().countryCode(CountryCode.ES)
                              .bankCode("2100")
                              .branchCode("0418")
        ...
        put("IR200170000000000123456789",
            new Iban.Builder().countryCode(CountryCode.IR)
                              .bankCode("017")
                              .accountNumber("0000000000123456789")
                              .build());
        put("FO9754320388899944",
            new Iban.Builder().countryCode(CountryCode.FO)
                              .bankCode("5432")
                              .accountNumber("038889994")
                              .nationalCheckDigit("4")
                              .build());
        put("GL8964710001000206",
            new Iban.Builder().countryCode(CountryCode.GL)
                              .bankCode("6471")
                              .accountNumber("0001000206")
                              .build());
        put("UA573543470006762462054925026",
            new Iban.Builder().countryCode(CountryCode.UA)
                              .bankCode("354347")
  ...
  public static Map<String, Iban> getNonStandardButValidIbans() {
    Map<String, Iban> data = new HashMap<String, Iban>() {{
